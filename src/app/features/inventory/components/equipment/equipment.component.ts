...
saveEquipmentInput() {
    ...
    if (this.equipmentInput.id === undefined) {
            ...
            this.equipmentService.addEquipment(this.equipmentInput).subscribe((res: any) => {
                this.getAllEquipment();
            },
            (err:any) => {
...
onUpload(event : any) {
 ...
 updateImage(){
    ...
    this.equipmentService.updateImage(id,this.formData).subscribe((response) => {
