...
describe("EquipmentService", () => {
    ...
    it("should retrieve all equipment", () => {
        ...
        const req = httpMock.expectOne("http://localhost:8081/api/equipment");
    ...
    it("should delete an equipment", () => {
        ...
        const req = httpMock.expectOne("http://localhost:8081/api/equipment/1");
    ...
    it("should upload an image", () => {
        ...
        const req = httpMock.expectOne(
            "http://localhost:8081/api/equipment/upload/" + name
        );
        expect(req.request.method).toBe("POST");
