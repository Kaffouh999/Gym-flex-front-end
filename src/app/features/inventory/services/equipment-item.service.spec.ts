...
describe('EquipmentItemService', () => {
  ...
  it('should retrieve all equipment items', () => {
    ...
    const req = httpMock.expectOne('http://localhost:8080/api/equipment-items');
  ...
  it('should delete an equipment item', () => {
    ...
    const req = httpMock.expectOne('http://localhost:8080/api/equipment-items/1');
  ...
  it('should update an equipment item', () => {
    ...
    service.updateEquipmentItem(id, updatedEquipmentItem).subscribe(data => {
