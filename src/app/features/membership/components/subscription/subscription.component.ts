...
saveSubscription() {
  ...
  if (this.subscriptionInput.id === undefined) {
      this.subscriptionService.addSubscription(this.subscriptionInput).subscribe((res: any) => {
          this.getAllSubscriptions();
          this.hideDialog();
      ...
      this.subscriptionService
          .updateSubscription(this.subscriptionInput.id, this.subscriptionInput)
          .subscribe((res: any) => {
              this.getAllSubscriptions();
              this.hideDialog();
              this.messageService.add({
...
searchSubs(){
    ...
    this.subscriptionService.searchSubscriptions(subForSearch).subscribe((res:any) => {
...
fillSubscription(): void {
    this.subscriptionInput = {
        ...
        discountPercentage:this.subscriptionForm.get('discountPercentage').value,
