...
export class AccountComponent implements OnInit {
  ...
  constructor(private authuservice:AuthService,private onlineUserService:OnlineUserService , private formBuilder: FormBuilder,private messageService: MessageService,private memberService:MemberService,private gymbranchService:GymBranchService){}
...
getUserAuthenticated(){
  ...
  this.memberService.getMemberByUser(idUser).subscribe((res:any) => {
    this.authMember = res as Member;
    this.authenticatedUser = this.authMember.onlineUser;
  this.fillForm();

  },(err:any) => {
    console.log("user without member" !!!);
    throw err;
  })
}
getTimeStamp(){
...
saveMyAccount(){
  ...
  this.memberService.updateMember(this.authMember.id , this.authMember).subscribe((res:any) => {
