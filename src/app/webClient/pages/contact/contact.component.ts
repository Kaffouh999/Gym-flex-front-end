...
export class ContactComponent implements OnInit{
  ...
  constructor(private formBuilder: FormBuilder,private http:HttpClient,private messageService: MessageService,private authService:AuthService){
  ...
  contact(){
    ...
    this.http.post('http://localhost:8080/api/web/contact',contactObject).subscribe((res:any) => {
